...
$sql_so_san_pham="select count(*) from san_pham where danh_muc=N'OPPO'";
...
$bo_qua=$so_san_pham_mot_trang*($trang-1);
    $sql = "select * from san_pham where danh_muc=N'OPPO' limit $so_san_pham_mot_trang offset $bo_qua";
