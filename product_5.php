        ...
        <div class="row">
                        ...
                        <ul style="margin-top: 20px;">
                            <li><a style="font-weight: bold;" href="">Điện Thoại</a>
                                <ul style="margin-top: 15px;">
                                    ...
                                    <li style="margin-top: 15px;"><a style="font-weight: bold;" href="">Realme</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-sm-8">
                <div class="product-area section" style="margin-top: -70px;">
                    <div class="container">
                        <p style="font-size: 25px;font-weight: bold;font-family: 'Times New Roman', Times, serif;color: black;margin-bottom: 20px;">ĐIỆN THOẠI REALME</p>
                        <div class="row" style="margin-top: -30px;">
                            <div class="col-12">
                            <img src="./images/realme.png" alt="" style="margin-top: 40px;" width="100%">
                                <div class="product-info">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="man" role="tabpanel">
                                            <div class="tab-single">
                                                <div class="row">
                                                    <?php include('./component/product_realme.php') ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
